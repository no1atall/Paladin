...
const Container = tw(ContainerBase)`bg-red-800 text-gray-400 -mx-8 px-8`;
...
const Plan = styled.div`
  ${tw`w-full max-w-sm bg-yellow-500 rounded-lg shadow-sm py-10 px-6 sm:px-10 lg:px-6 lg:py-10 xl:p-10 mx-3 flex flex-col justify-between mt-16 first:mt-0 lg:mt-0 shadow-raised`}
`;
...
const PlanHeader = styled.div`
  ...
  .featuredText {
    ${tw`text-xs font-bold px-3 rounded py-2 uppercase bg-gray-300 text-orange-600 leading-none mt-4 sm:mt-0 w-full sm:w-auto text-center`}
  }
  .pricingContainer {
...
const PlanFeatures = styled.ul`
  ...
  .feature {
    ...
    .icon {
      ${tw`w-6 h-6 text-orange-600 flex-shrink-0`}
    }
    .text {
      ${tw`font-semibold text-orange-600 tracking-wide ml-3`}
    }
  }
`;
